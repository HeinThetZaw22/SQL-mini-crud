...
<section class=" max-w-5xl mx-auto p-10">
    ...
    <form action="./product-update.php" method="post">
        <div class="flex items-center justify-center gap-1  my-10">
            <div>
                <input type="hidden" class="py-3 px-4 block  border-gray-200  rounded-lg text-sm" name="row_id" value="<?= $row['id'] ?>">
            </div>
            <div class="relative">
                <input value="<?= $row['name'] ?>" name="name" required type="text" id="name" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
  focus:pt-6
  focus:pb-2
  ...
  autofill:pb-2" placeholder="you@email.com">
    ...
    peer-[:not(:placeholder-shown)]:text-gray-500">Name</label>
            ...
            <div class="relative">
                <input value="<?= $row['price'] ?>" name="price" required type="number" id="price" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
  focus:pt-6
  focus:pb-2
  [&:not(:placeholder-shown)]:pt-6
  [&:not(:placeholder-shown)]:pb-2
  autofill:pt-6
  autofill:pb-2" placeholder="you@email.com">
                <label for="price" class="absolute top-0 start-0 p-4 h-full text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent dark:text-white peer-disabled:opacity-50 peer-disabled:pointer-events-none
    peer-focus:text-xs
    peer-focus:-translate-y-1.5
    peer-focus:text-gray-500
    peer-[:not(:placeholder-shown)]:text-xs
    peer-[:not(:placeholder-shown)]:-translate-y-1.5
    peer-[:not(:placeholder-shown)]:text-gray-500">Price</label>
            </div>
            <div class="relative">
                <input value="<?= $row['stock'] ?>" name="stock" required type="number" id="stock" class="peer p-4 block w-full border-gray-200 rounded-lg text-sm placeholder:text-transparent focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600
  focus:pt-6
  focus:pb-2
  [&:not(:placeholder-shown)]:pt-6
  [&:not(:placeholder-shown)]:pb-2
  ...
  autofill:pb-2" placeholder="you@email.com">
    ...
    peer-[:not(:placeholder-shown)]:text-xs
    peer-[:not(:placeholder-shown)]:-translate-y-1.5
    peer-[:not(:placeholder-shown)]:text-gray-500">Stock</label>
            </div>
        ...
        <button class="py-3 px-4 inline-flex w-full justify-center text-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-100 text-blue-800 hover:bg-blue-200 disabled:opacity-50 disabled:pointer-events-none">Update</button>
    </form>
</section>
