...
<section class=" max-w-5xl mx-auto p-10">
    <div class="flex gap-3 items-center justify-between">
        <h2 class=" text-2xl font-bold">MY FRUIT SHOP</h2>
            ...
            <div class="hs-carousel relative overflow-hidden w-full min-h-[350px] bg-white rounded-lg">
                <div class="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
                    <div class="hs-carousel-slide">
                        <div class="flex justify-center h-full bg-slate-500 p-6">
                            <span class="self-center text-4xl transition duration-700">
                                <img class="" src="https://img.freepik.com/free-vector/shop-with-sign-we-are-open_23-2148552020.jpg" alt="">
                            </span>
                        </div>
                    </div>
                    <div class="hs-carousel-slide">
                        <div class="flex justify-center h-full bg-gray-200 p-6">
                            <span class="self-center text-4xl transition duration-700">Get discount here</span>
                        </div>
                    </div>
                    <div class="hs-carousel-slide">
                        <div class="flex justify-center h-full bg-gray-300 p-6">
                            <span class="self-center text-4xl transition duration-700">Let's explore together</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-12 gap-4 mt-20">
        <div class="col-span-2  flex items-center justify-center bg-gray-200 rounded p-5 ">
        ...
        <div class="col-span-2  flex items-center justify-center bg-gray-500 rounded p-5 ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
            </svg>

        </div>
        <div class="col-span-2  flex items-center justify-center bg-gray-300 rounded p-5 ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
